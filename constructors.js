...
//name, age, email, and savedPosts in that order. Name and email will be strings, age will be 
//a number and savedPosts will be an array of objects. These objects will each have 3 properties: id (a number), 
...
//that will take in two number parameters. The first will be an id (a number) and 
//the second will be the new rating (a number). Use the id to find the matching object in the savedPosts array.
